  ...
  return (
    <div className="site-shell contacts-page">
      ...
      <main className="contacts-main">
        ...
        <section className="map-placeholder" aria-label="Будущее размещение карты">
          <div className="map-noise" aria-hidden="true" />
          <div className="map-copy"><MapPin size={22} /><span className="section-number">КАРТА</span><h2>Мы на карте</h2><p>Раздел для карты появится здесь после подтверждения официального адреса.</p></div>
          <div className="map-coordinate map-coordinate-one" aria-hidden="true">МЕСТОПОЛОЖЕНИЕ / ОФИЦИАЛЬНЫЙ АДРЕС</div>
          <div className="map-coordinate map-coordinate-two" aria-hidden="true">КООРДИНАТЫ / ПО ЗАПРОСУ</div>
